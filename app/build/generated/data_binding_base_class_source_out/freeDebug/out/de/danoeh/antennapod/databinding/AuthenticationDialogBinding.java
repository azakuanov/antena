...
public final class AuthenticationDialogBinding implements ViewBinding {
  ...
  private AuthenticationDialogBinding(@NonNull LinearLayout rootView,
      @NonNull TextInputEditText passwordEditText, @NonNull IconTextView showPasswordButton,
  ...
  public static AuthenticationDialogBinding bind(@NonNull View rootView) {
    ...
    String missingId;
    missingId: {
      TextInputEditText passwordEditText = rootView.findViewById(R.id.passwordEditText);
      if (passwordEditText == null) {
        missingId = "passwordEditText";
        break missingId;
      }
      IconTextView showPasswordButton = rootView.findViewById(R.id.showPasswordButton);
      if (showPasswordButton == null) {
        missingId = "showPasswordButton";
        break missingId;
      }
      TextInputEditText usernameEditText = rootView.findViewById(R.id.usernameEditText);
